<?php
/**
 * Marker post type registration.
 *
 * @package Minimal_Map
 */

namespace MinimalMap\Markers;

/**
 * Registers the marker content model.
 */
class Marker_Post_Type {
	/**
	 * Capability required to manage markers.
	 */
	const CAPABILITY = 'manage_options';

	/**
	 * Marker post type slug.
	 */
	const POST_TYPE = 'minimal_map_marker';

	/**
	 * REST base.
	 */
	const REST_BASE = 'minimal_map_marker';
	...
	public function register() {
		register_post_type(
			...
			array(
				...
				'map_meta_cap'        => true,
				'capability_type'     => array( 'minimal_map_marker', 'minimal_map_markers' ),
	...
	/**
	 * Get mapped primitive capabilities for the marker post type.
	 *
	...
	/**
	 * Get the current published marker count.
	 *
	 * @return int
	 */
	public static function get_marker_count() {
